...
# Implemented by David PICCAND
# class ATT(TalkerSentence):
#     """ GPatt
#     """
#     fields = (
#         ("Heading true", "hdg_true", Decimal),
#         ("Pitch", "pitch", Decimal),
#         ("Roll", "roll", Decimal),
#     )
...
class VDM(TalkerSentence):
    fields = (
        ("Command", "cmd"),
        ("count of fragments", "count_of_fragments"),
        ("fragment number", "fragment_number"),
        ("radio channel code", "code"),
